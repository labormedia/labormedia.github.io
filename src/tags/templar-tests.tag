...
<virtual type="x-shader/x-vertex" id="vshader">
...
<virtual type="x-shader/x-fragment" id="fshader">
...
<script type="text/javascript" src="src/libraries/basic-objects-IFS.js"></script>
<script type="text/javascript" src="src/libraries/simple-rotator.js"></script>
...
<script type="text/javascript">
    ...
    var glMatrix = riot.cloneObject(riot.M.glMatrix);
    var mat2 = riot.cloneObject(riot.M.mat2);
    var mat2d = riot.cloneObject(riot.M.mat2d);
    var mat3 = riot.cloneObject(riot.M.mat3);
    var mat4 = riot.cloneObject(riot.M.mat4);
    var quat = riot.cloneObject(riot.M.quat);
    var vec2 = riot.cloneObject(riot.M.vec2);
    var vec3 = riot.cloneObject(riot.M.vec3);
    var vec4 = riot.cloneObject(riot.M.vec4);
